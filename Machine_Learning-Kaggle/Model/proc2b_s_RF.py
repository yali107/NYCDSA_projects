...
subm.to_csv('proc2b_s_RF_t.csv', index=False)
...
test_sub = pd.read_csv("./Processed2/submit_encode2.csv")
X_sub = test_sub
...
print submission
submission.to_csv("proc2b_s_RF_tAll.csv", index=None)
