...
print subm
subm.to_csv("proc2b_s_XGB2_t_n2235.csv", index=None)
...
overall_model = xgb.train(params, xgtrain_full, 2235, feval=xg_eval_mae)
...
print subm
submission.to_csv("proc2b_s_XGB2_tAll_n2235.csv", index=None)
