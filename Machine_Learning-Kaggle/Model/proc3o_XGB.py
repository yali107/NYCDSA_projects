...
if __name__ == "__main__":
    print('Started')
    # directory = '../input/'
    train = pd.read_csv('./dataset1/train_1.csv')
    test = pd.read_csv('./dataset1/test_1.csv')
    submission = pd.read_csv('./dataset1/sample_submission_1.csv')
    ...
    if (kfolds > 1):
        ...
        submission.to_csv('proc3o_XGB_tAll.csv', index=None)
        # submission.iloc[:, 1] = \
